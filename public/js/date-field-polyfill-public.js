      ...
      function (t, e, n) {
        ...
        t.exports = function (t, e, n, b, g, x, M) {
          ...
          if (
            ...
            if (
              ((w = { values: _ ? j : D(m), keys: x ? j : D(y), entries: C }),
              M)
            )
                  ...
                  valueAsDate: {
                    get: function () {
                      ...
                      var t = n.format || "yyyy-mm-dd",
                        ...
                        o = {};
                      return (
                        t.replace(/(yyyy|dd|mm)/g, function (t) {
                          o[t] = r++;
                        }),
                  ...
                  switch (t.keyCode) {
                    ...
                    case 38:
                      n.element.valueAsDate &&
                        (e.setDate(n.element.valueAsDate.getDate() + 1),
            ...
            function t() {
              ...
              (this.daysHead = document.createElement("thead")),
                ...
                (this.removeClickOut = function (t) {
                  if (e.isOpen) {
                    for (
                      var n = t.target, r = n === e.container || n === e.input;
                      !r && (n = n.parentNode);

                    )
                      r = n === e.container;
                    (("date" !== t.target.getAttribute("type") && !r) || !r) &&
                      e.hide();
                  }
                }),
                ...
                [
                      ...
                      n.right < o
                        ? ((a = n.left),
                          (this.container.className =
                            i() + " polyfill-left-aligned"))
                        : (this.container.className =
                            i() + " polyfill-right-aligned"),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      isNaN(Date.parse(this.input.valueAsDate))
                        ? (this.date = new Date())
                        : (this.date = t.absoluteDate(this.input.valueAsDate)),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      for (
                        var e = ["<tr>"], n = 0, r = this.locale.days.length;
                        n < r;
                        ++n
                      )
                        e.push(
                    ...
                    value: function () {
                      ...
                      for (
                        var e = this.date.getFullYear(),
                          ...
                          i = t.absoluteDate(this.input.valueAsDate) || !1,
                          a = i && e === i.getFullYear() && n === i.getMonth(),
                          u = [],
                          s = 0;
                        s < o + r;
                        ++s
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      return (
                        t &&
                        new Date(t.getTime() + 60 * t.getTimezoneOffset() * 1e3)
                      );
                    },
                  },
                ]
      ...
      function (t, e, n) {
        ...
        var r = n(2),
          ...
          Q = function (t) {
            ...
            return (
              !(this === R && o(I, t) && !o(Y, t)) &&
              (!(e || !o(this, t) || !o(I, t) || (o(this, P) && this[P][t])) ||
                e)
            );
          },
          X = function (t, e) {
      ...
      function (t, e, n) {
        ...
        var p = {},
          h = function (t) {
            ...
            return function () {
              return (
                "undefined" == typeof e && (e = t.apply(this, arguments)), e
              );
            };
          },
          y = h(function () {
